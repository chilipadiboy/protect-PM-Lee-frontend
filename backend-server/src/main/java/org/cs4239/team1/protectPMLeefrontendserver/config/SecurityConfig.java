        ...
        http
                ...
                .authorizeRequests()
                    ...
                    .antMatchers("/api/auth/signup")
                        .hasAnyRole("ADMINISTRATOR", "EXTERNAL_PARTNER")
                    .antMatchers("/api/auth/signin", "/api/auth/firstAuthorization", "/api/auth/secondAuthorization")
                        .permitAll()
                    ...
                    .antMatchers("/api/treatments/getAll/")
                        .hasRole("ADMINISTRATOR")
                    .antMatchers("/api/treatments/getPatients/")
                        .hasRole("THERAPIST")
